...
import com.example.testapp.DealerDetailActivity;
import com.example.testapp.GSTINSearchActivity;
import com.example.testapp.bean.GSTDetails;
...
public class ApiCallAsyncTask extends AsyncTask<String,Void,String> {
    ...
    protected void onPreExecute() {
        ...
        p = new ProgressDialog(gstin_activity);
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            if (!gstDetailsList.isEmpty()) {
                GSTDetails gstDetails = gstDetailsList.get(0); // Get the first object

                // Store values in string variables
                String gstin = gstDetails.getGstin();
                String tradeName = gstDetails.getTrade_name();
